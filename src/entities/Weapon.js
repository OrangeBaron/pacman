...
import { createPistolMesh, createRifleMesh } from '../components/WeaponModels.js';
...
export class Weapon {
    ...
    shoot(ghosts, vrController = null, collisionSystem) {
        ...
        // DELEGHIAMO IL CALCOLO AL COLLISION SYSTEM
        const hitData = collisionSystem.raycastShoot(this.raycaster);
        
        // Gestiamo l'output ripulito
        hitData.ghosts.forEach(hitGhost => {
            hitGhost.takeDamage();
            STATS.shotsHit++;
        });
